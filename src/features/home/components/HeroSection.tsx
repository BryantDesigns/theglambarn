...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-sky-mist">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-16 top-24 h-72 w-72 rounded-full bg-rose-gold/20 blur-3xl"
      />
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 sm:px-8 lg:min-h-[calc(100vh-4rem)] lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-12 lg:py-20">
        <div className="relative z-10">
          <p className="inline-flex items-center rounded-full border border-rose-gold/30 bg-white/60 px-4 py-1.5 font-sans text-[11px] font-semibold uppercase tracking-[0.24em] text-rose-gold">
            Nail Salon · Walk-Ins Welcome
          </p>
          <h1 className="mt-6 font-script text-[clamp(2.8rem,8vw,5.5rem)] leading-tight text-rose-gold">
            Where Rustic Charm
            <br />
            Meets Luxe Nails
          </h1>
          ...
          <p className="mt-6 font-sans text-sm italic text-rose-gold/70">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[28rem]">
          ...
          <div className="absolute -bottom-4 right-4 rounded-2xl border border-white/60 bg-white/90 px-4 py-3 shadow-lg backdrop-blur">
            <p className="font-sans text-[10px] font-semibold uppercase tracking-[0.2em] text-rose-gold/75">
              Walk-Ins Welcome
            </p>
