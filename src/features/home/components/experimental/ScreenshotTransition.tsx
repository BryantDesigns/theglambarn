...
export function ScreenshotTransition() {
  ...
  return (
    <div className="bg-barn-white py-24 sm:py-32">
      {/* Text header — copied from TailwindPlus exactly */}
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="font-sans text-base/7 font-semibold text-rustic-brown">
            Everything you need
          </h2>
          <p className="font-script mt-2 text-4xl text-rustic-brown sm:text-5xl">
            You deserve nails that wow.
          </p>
          <p className="mt-6 font-sans text-lg/8 text-neutral-600">
            The Glam Barn is built around one thing: making sure you leave obsessed with your nails. Here&rsquo;s what sets us apart.
          </p>
        </div>
      </div>

      {/* Screenshot block — structure is 1:1 from TailwindPlus */}
      <div className="relative overflow-hidden pt-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <Image
            ...
            className="mb-[-12%] rounded-xl shadow-6xl/90 ring-2 ring-blush/90"
            style={{ width: "100%", aspectRatio: "16 / 10", objectFit: "cover", objectPosition: "center 75%" }}
          />
          {/* Gradient sibling — fades the bottom of the photo into bg-barn-white */}
          <div aria-hidden="true" className="relative">
            <div className="absolute -inset-x-20 bottom-0 bg-linear-to-t from-barn-white pt-[20%]" />
          </div>
        </div>
      </div>
      ...
      <section id="gallery" className="overflow-hidden bg-barn-white py-20">
            {/* Header */}
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
